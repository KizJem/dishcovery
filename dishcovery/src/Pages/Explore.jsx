...
const styles = {
  ...
  toolButton: { padding: "14px 22px", border: "none", borderRadius: 12, backgroundColor: "#f5f5f5", fontSize: 16, fontWeight: 500, cursor: "pointer", transition: "all 0.3s ease" },
  dishesSection: { marginTop: 40 },
  sectionTitle: { fontSize: 22, fontWeight: 600, marginBottom: 25, color: "#222" },
  dishesGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 },
  card: { background: "#fff", borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 6px rgba(0,0,0,0.1)", textAlign: "center", transition: "transform 0.3s ease" },
  cardImage: { width: "100%", height: 180, objectFit: "cover" },
  cardContent: { padding: 15 },
  cardTitle: { fontSize: 18, fontWeight: 600, marginBottom: 10 },
  cardButton: { border: "none", background: "#000", color: "#fff", padding: "10px 20px", borderRadius: 25, fontSize: 14, cursor: "pointer", transition: "all 0.3s ease" },
};
