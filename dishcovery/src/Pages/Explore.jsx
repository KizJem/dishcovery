            ...
            <div style={styles.page}>
                ...
                <section style={styles.toolsSection}>
                    ...
                    <div style={styles.toolsGrid}>
                        <button style={styles.toolButton}>What's in Your Fridge →</button>
                        <button style={styles.toolButton}>Find by Ingredient →</button>
                        <button style={styles.toolButton}>Nutrition Visualizer →</button>
                        <button style={styles.toolButton}>Instruction Analyzer →</button>
                        <button style={styles.toolButton}>Meal Planner →</button>
                    </div>
                </section>
                ...
                <section style={styles.dishesSection}>
                    ...
                    <div style={styles.dishesGrid}>
                        {["Dinner", "Vegetarian", "Healthy", "Instant Pot", "Vegan"].map(
                            (category, index) => (
